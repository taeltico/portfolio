...
def bot():
	try:
		...
		bolinha = driver.find_element_by_class_name('_38M1B')
		bolinha = driver.find_elements_by_class_name('_38M1B')
		...
		todas_as_msg = driver.find_elements_by_class_name('_3ExzF')
		todas_as_msg_texto = [e.text for e in todas_as_msg]
		msg = todas_as_msg_texto[-1]
		print(msg)
		#RESPONDER A MENSAGEM
		campo_de_texto = driver.find_element_by_xpath('//*[@id="main"]/footer/div[1]/div[2]/div/div[2]')
		...
		contato_padrao = driver.find_element_by_class_name('_2TiQe')
